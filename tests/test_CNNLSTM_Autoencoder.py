...
class TestCNNLSTMAutoencoder(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.autoencoder = CNNLSTMAutoencoder(self.input_shape)

    def test_model_creation(self):
        """
        Test the successful creation of a CNN-LSTM Autoencoder model.
        """
    ...
    def test_model_training(self, mock_fit):
        ...
        mock_fit.assert_called_with(x=X_train, y=y_train, epochs=epochs, batch_size=batch_size,
